...
export type QuestionAnswerID = string & { readonly _: unique symbol }
export type QuestionAnswerBatchID = string & { readonly _: unique symbol }
...
export type VoucherRewardID = string & { readonly _: unique symbol }
